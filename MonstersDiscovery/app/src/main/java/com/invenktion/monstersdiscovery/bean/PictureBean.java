...
public class PictureBean {
	...
	public Bitmap getColoredPicture(Context context) {
		int H = (int)(ApplicationManager.SCREEN_W*0.26);
	...
	public String getTitle(Context context) {
        ...
        String newName = settings.getString(univoqueCode+"_renamed_by_user", "");
	...
	public void changeNameByUser(String newName, Context context) {
		SharedPreferences settings = context.getSharedPreferences(ApplicationManager.PREFS_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
        editor.putString(univoqueCode+"_renamed_by_user", newName);
        //Commit the edits!
        editor.commit();
	}
