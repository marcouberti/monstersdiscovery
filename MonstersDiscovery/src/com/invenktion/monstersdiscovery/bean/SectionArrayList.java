package com.invenktion.monstersdiscovery.bean;
 ...
 */
public class SectionArrayList<T> extends ArrayList<com.invenktion.monstersdiscovery.bean.PictureBean>{
	...
	public int getTelaFrontImage() {
		return telaFrontImage;
	}

	public void setTelaFrontImage(int telaFrontImage) {
		this.telaFrontImage = telaFrontImage;
	}
